<?php
header ("refresh:200;url=realtime-query.php");
...
<h3>Realtime --- username = "<?php echo $_SESSION[Session::Name]; ?>" </h3><hr />
...
<!--    <label><input type="hidden" type="radio" id="query-chbutton" >FUCK YOU!</label>-->
